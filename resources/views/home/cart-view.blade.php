@if(isset($cart) && count($cart) > 0)
    ...
    <div class="the-menu-item" style="padding:0" data-product={{ $itemId }}>
        <div class="the-menu-body">
            <span class="menu-title" style="display:inline-block;width:70%;">{{ ucwords($itemDetails['item']) }}</span>
            
            <span style="display:inline-block;width:15%;">X</span>
    
            <span>
                <input type="text" style="width: 10%;" value="{{ $itemDetails['quantity'] }}">
            </span>
        </div>
